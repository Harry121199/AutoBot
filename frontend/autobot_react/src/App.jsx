          ...
          <FormControl fullWidth sx={{ mb:2 }}>
            ...
            <Select
              ...
              onChange={(e) => setTone(e.target.value)}>
                ...
                <MenuItem value="light mood">light mood</MenuItem>
                <MenuItem value="Suitable mood">Suitable mood</MenuItem>
                <MenuItem value="happy">Happy</MenuItem>
                <MenuItem value="angry">Angry</MenuItem>
                <MenuItem value="according to message">According to message</MenuItem>
            </Select>
          </FormControl>
